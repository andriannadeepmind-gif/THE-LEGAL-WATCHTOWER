...
(:lawmax-ceiling-crosswalk 1
 ...
 ((:r 1 "το Σύνταγμα δεσμεύει ΚΑΘΕ committer — αχαρτογράφητο ⇒ κόκκινη πύλη, αδιακρίτως προέλευσης")
  ...
  (:r 8 "διάλογος = ένα αρχείο ανά καταχώρηση deployment/collab/dialogue/NNNN-<όνομα>.md (lock-free)· pull πριν γράψεις· ΠΟΤΕ edit αρχείου άλλου AI· AI-DIALOGUE.md = ευρετήριο"))
