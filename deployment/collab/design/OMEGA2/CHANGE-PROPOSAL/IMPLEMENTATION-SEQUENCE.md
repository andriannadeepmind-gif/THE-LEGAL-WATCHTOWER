# IMPLEMENTATION SEQUENCE — ΒΗΜΑΤΑ 0 ΕΩΣ 14 ΜΕΤΑ ΤΟ FREEZE (ΔΕΝ ΥΛΟΠΟΙΕΙΤΑΙ ΤΩΡΑ)
...
15 φέτες ως προδιαγραφή (`VERTICAL-SLICES.md`), (γ) ρητό «εγκρίνω freeze target» του
