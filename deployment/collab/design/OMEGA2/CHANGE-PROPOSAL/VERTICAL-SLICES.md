...
**Καμία φέτα δεν έχει εκτελεστεί.** (Διόρθωση #17: οι φέτες εκτελούνται **μετά** το
`SPEC FREEZE`, στη φάση υλοποίησης — **δεν** είναι προϋπόθεση του freeze· η επικύρωση
του **πυρήνα του πρωτοκόλλου** έγινε νωρίτερα και εκτελέσιμα στο
`deployment/verify/mltp3/`, MLTP v3 §13.)
