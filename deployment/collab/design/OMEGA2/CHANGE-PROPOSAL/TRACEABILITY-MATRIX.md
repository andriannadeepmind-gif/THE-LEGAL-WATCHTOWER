...
| R-129 | MIS-1, MIS-5 | CAP-156 | POST-C2 Finding 1: γλωσσο-ανεξάρτητο formal semantic contract· δύο compilers χωρίς κοινό evaluator code· canon-priority ολική ή CONFLICTING | `LAWMAX-LEGAL-IR-SEMANTIC-CONTRACT.md`· v1.4 §4.17 | conformance corpus input→derivation | I-4.17a, I-4.17b, I-4.17c | KW-105 | VS-09, VS-10 | SEMANTIC-CONTRACT (design· PARTIALLY CLOSED) | S (design) |
