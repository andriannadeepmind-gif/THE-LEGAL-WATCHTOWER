...
| R-132 | MIS-2, MIS-1 | CAP-157 | POST-C2 closure: πλήρες δημόσιο νομικό σύμπαν ως απαριθμήσιμο μητρώο ST-01..21· authority-metadata ανά τύπο· source-specific profiles/compilers· καμία κατηγορία χωρίς collector/profile/compiler | `LAWMAX-PUBLIC-SOURCE-TYPE-AUTHORITY-REGISTRY.md`· v1.4 §4.20 | ST-nn registry + encoding profiles | I-4.20a, I-4.20b, I-4.20c | KW-109 | VS-13 | SOURCE-REGISTRY (design)· census total function | S (design) |
| R-133 | MIS-9, MIS-1 | CAP-158 | POST-C2 closure: secure semantic ingress — external bytes ≠ Lisp forms· taint states· sandboxed capability-less parsing· SIK-1..9 | `LAWMAX-SECURE-SEMANTIC-INGRESS-CONTRACT.md`· `source/safe-read.lisp` (EXTEND)· v1.4 §4.21 | taint UNTRUSTED→CANONICAL + closed AST | I-4.21a, I-4.21b, I-4.21c | KW-108 | VS-06 | INGRESS-CONTRACT (design)· threat Θ18 | S (design) |
