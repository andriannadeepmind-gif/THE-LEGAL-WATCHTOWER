...
### [0091+++β] Διόρθωση κατ' εντολή: institutional-register/1 + αναλλοίωτο έννομης πραγματικότητας

Ο δημιουργός διόρθωσε τη διατύπωση της υποφάσης: ΟΧΙ στενά protocol-register
— **`institutional-register/1`**: ΕΝΑΣ μηχανισμός παράγωγης ταυτότητας
(ireg1: = hash{jurisdiction, founding_locator+version_pin,
canonical_register_key}) για ΚΑΘΕ θεσμικό μητρώο της έννομης τάξης
(νομοθετικό, διοικητικό, δικαστικό, συνταγματικό, ευρωπαϊκό, διεθνές).
Ρητό **ΑΝΑΛΛΟΙΩΤΟ ΘΕΣΜΙΚΗΣ ΤΑΥΤΟΤΗΤΑΣ** (register_id ΚΑΙ authority_id):
σταθερά όταν μεταβάλλεται ΟΠΟΙΟΔΗΠΟΤΕ μη ταυτοτικό στοιχείο της ιστορικά
μεταβαλλόμενης έννομης πραγματικότητας — όνομα, εποπτεύουσα αρχή,
αρμοδιότητα, γεωγραφικό πεδίο, οργανωτική υπαγωγή, νομική μορφή, σειρά
αρίθμησης, τρόπος δημοσίευσης, δικαιοδοτική ένταξη (όλα = διτεμπορικά
assertions εκτός identity)· πραγματική οντολογική ασυνέχεια (κατάργηση+
ίδρυση, νέα συνταγματική θεμελίωση, διάσπαση, συγχώνευση, επανίδρυση) ⇒
ΝΕΑ ταυτότητα με ΥΠΟΧΡΕΩΤΙΚΟ evidence-backed lineage. Ο
W-REGISTER-REASSIGNMENT διευρύνθηκε: σάρωση ΟΛΩΝ των μη ταυτοτικών
μεταβολών ⇒ ids αμετάβλητα· ασυνέχεια χωρίς lineage record ⇒ reject.
