(:lawmax-phase1a-cluster/1
 ...
 ((:name "GATE-4 — Pipeline integrity (no subprocess)"
  ...
  (:name "Πραγματικά subprocess seats στον κώδικα"
   ...
   :evidence "source/document-fetch.lisp:L92-L106@sha256:bb114b83fd80 source/pdf-authority.lisp:L1386-L1425@sha256:c4e2054c0e4f Dockerfile:371-373")
  ...
  (:name "Shell ως έδρα εκτέλεσης ΚΑΙ κρίσης της αποδεικτικής αλυσίδας"
   ...
   :mechanism :structural
   :evidence "Dockerfile:167 Dockerfile:189-192 Dockerfile:290 .github/workflows/docker-orchestrator.yml:L298-L299@sha256:f1a4bb69e6e4")
  ...
  (:name "Reproducibility — byte-identical output υπό SOURCE_DATE_EPOCH"
   ...
   :mechanism :text-only
   :evidence "README.md:L332-L332@sha256:97c747e9aa82 Dockerfile:17 Dockerfile:64 SEMANTIC-CONTRACT.md:L56-L62@sha256:260308c8e7ee")
  ...
  (:name "Έμπιστο μονοπάτι εκκίνησης (entrypoint)"
   ...
   :mechanism :structural
   :evidence "Dockerfile:452 docker/entrypoint.lisp:L67-L77@sha256:b4f283f2abed docker/entrypoint.lisp:L115-L154@sha256:b4f283f2abed build.lisp:L43-L47@sha256:baa3527f5cf6"))
 ...
 ((:statement "The only subprocess is the Lisp runtime itself"
  ...
  (:statement "NO Quicklisp"
   ...
   :evidence "DEPENDENCY-CONTRACT.md:L183-L188@sha256:65a3f5df825c Dockerfile:108 build.lisp:L11-L11@sha256:baa3527f5cf6")
 ...
 (;; ── Η ΕΙΔΙΚΗ ΕΝΤΟΛΗ ──
  ...
  (:what "«100% Common Lisp» / «Pure Lisp 100%»: το repo περιέχει 59 μη-Lisp αρχεία πηγής εκτός third-party/ και output/ — 22 .py, 27 .sh, 6 .js, 2 .mjs, 2 .ts. Η ΤΕΛΙΚΗ ΚΡΙΣΗ της ολομέλειας πυλών αποδίδεται από bash (deployment/verify/assess-gate-plenary.sh) και το build-gate του proof manifest από Python."
   :severity :p1
   :evidence "README.md:L8-L8@sha256:97c747e9aa82 README.md:L16-L16@sha256:97c747e9aa82 README.md:L389-L389@sha256:97c747e9aa82 .github/workflows/docker-orchestrator.yml:L298-L299@sha256:f1a4bb69e6e4 Dockerfile:316"
   :is-it-in-the-known-defect-list :no)
  (:what "«Multi-stage hermetic build» (Dockerfile:5) + machine-readable «hermetic: enabled: true, no_network: true» (PROVENANCE.yaml:L292-L295@sha256:bce8df3c6d34) + «Criterion 2 ✅ docker build --network=none» (DEPENDENCY-CONTRACT.md:L168-L173@sha256:65a3f5df825c): και τα τρία διαψεύδονται από 3× apt-get update && apt-get install χωρίς καθήλωση εκδόσεων. Με --network=none το stage 1 αποτυγχάνει αμέσως."
   :severity :p1
   :evidence "Dockerfile:5 Dockerfile:41-43 Dockerfile:68-77 Dockerfile:363-377 PROVENANCE.yaml:L292-L295@sha256:bce8df3c6d34 DEPENDENCY-CONTRACT.md:L168-L173@sha256:65a3f5df825c"
   :is-it-in-the-known-defect-list :no)
  ...
  (:what "ΤΕΣΣΕΡΑ δηλωμένα scripts επαλήθευσης ΔΕΝ ΥΠΑΡΧΟΥΝ: PROVENANCE.yaml:L286-L286@sha256:bce8df3c6d34 «scripts/verify-deps.sh», PROVENANCE.yaml:L289-L289@sha256:bce8df3c6d34 «scripts/generate-deps-lock.sh», DEPENDENCY-CONTRACT.md:L194-L194@sha256:65a3f5df825c DEPENDENCY-CONTRACT.md:L213-L213@sha256:65a3f5df825c «docker/verify-deps.sh», SEMANTIC-CONTRACT.md:L61-L61@sha256:260308c8e7ee «./scripts/verify-deterministic-build.sh». Τα πραγματικά είναι docker/verify-deps.lisp και scripts/gen-deps-lock.lisp — δηλαδή ΤΡΙΑ διαφορετικά ονόματα για την ΙΔΙΑ έδρα σε τρία συμβόλαια."
   :severity :p1
   :evidence "PROVENANCE.yaml:L286-L286@sha256:bce8df3c6d34 PROVENANCE.yaml:L289-L289@sha256:bce8df3c6d34 DEPENDENCY-CONTRACT.md:L194-L194@sha256:65a3f5df825c SEMANTIC-CONTRACT.md:L61-L61@sha256:260308c8e7ee deps.lock:5-6"
   :is-it-in-the-known-defect-list :no)
  (:what "SEMANTIC-CONTRACT.md:L60-L60@sha256:260308c8e7ee διδάσκει «sha256sum -c deps.lock» — δομικά αδύνατο: το deps.lock είναι «<dir> | <sha256>» (deps.lock:2), όχι η μορφή «<hash>  <path>» που δέχεται το sha256sum -c."
   :severity :p2
   :evidence "SEMANTIC-CONTRACT.md:L60-L60@sha256:260308c8e7ee deps.lock:2"
   :is-it-in-the-known-defect-list :no)
  (:what "DEPENDENCY-CONTRACT.md:L183-L188@sha256:65a3f5df825c «Criterion 4: No Quicklisp runtime calls ✅» με grep σε source/ systems/: (α) εκτελούμενο ΣΗΜΕΡΑ ΕΠΙΣΤΡΕΦΕΙ ΕΥΡΗΜΑΤΑ (systems/orchestrator-omega-modules/omega-package.lisp:L46-L46@sha256:6e4e14e66418 + README.md:L116-L211@sha256:97c747e9aa82) ⇒ το κριτήριο που δηλώνεται ✅ αποτυγχάνει· (β) το πεδίο του grep αποκλείει ΑΚΡΙΒΩΣ τον χώρο της πραγματικής παράβασης (Dockerfile.test:29, MANUAL-STEPS-HERMETIC.md:L59-L59@sha256:cfd4fd227483). Φρουρός γύρω από λάθος σχήμα."
   :severity :p1
   :evidence "DEPENDENCY-CONTRACT.md:L183-L188@sha256:65a3f5df825c systems/orchestrator-omega-modules/omega-package.lisp:L46-L46@sha256:6e4e14e66418 Dockerfile.test:29"
   :is-it-in-the-known-defect-list :no)
  ...
  (:what "Το τεκμηριωμένο quickstart «docker compose build && docker compose up» (README:64-65) δεν μπορεί να πετύχει: το compose περνά GIT_COMMIT default «dev» ενώ ο Dockerfile απαιτεί ακριβώς 40-hex αλλιώς FATAL exit 1 — και το target runtime περνά υποχρεωτικά από εκείνο το στάδιο."
   :severity :p1
   :evidence "docker-compose.yml:L8-L8@sha256:ff93c313b8fe Dockerfile:172-173 README.md:L64-L65@sha256:97c747e9aa82"
   :is-it-in-the-known-defect-list :no)
  (:what "authority-v2-proofs: privileged:true + ΟΛΟΚΛΗΡΟ το repo ως «.:/repo:rw» + bash + apt-get install sbcl python3 util-linux + image debian:bookworm-slim με UNPINNED tag (ενώ ο Dockerfile καρφώνει digest). Είναι η υπηρεσία που παράγει τις αποδείξεις ορίου πυρήνα."
   :severity :p1
   :evidence "docker-compose.yml:L376-L397@sha256:ff93c313b8fe Dockerfile:23"
   :is-it-in-the-known-defect-list :no)
  (:what "Dockerfile.test κατεβάζει Quicklisp από το δίκτυο (curl https://beta.quicklisp.org/quicklisp.lisp) και κάνει ql:quickload :fiveam ως root, ενώ Dockerfile:108, build.lisp:L11-L11@sha256:baa3527f5cf6 και DEPENDENCY-CONTRACT.md:L207-L207@sha256:65a3f5df825c δηλώνουν ρητά «NO Quicklisp». Κανένα build/CI/compose αρχείο δεν το αναφέρει."
   :severity :p1
   :evidence "Dockerfile.test:9-30 Dockerfile:108 build.lisp:L11-L11@sha256:baa3527f5cf6 DEPENDENCY-CONTRACT.md:L207-L207@sha256:65a3f5df825c"
   :is-it-in-the-known-defect-list :yes)
  ...
  (:what "CI βήμα «Smoke test orchestrator loading» κάνει asdf:load-asd \"/app/orchestrator.asd\" στο orchestrator:test, αλλά το runtime stage δεν αντιγράφει ΚΑΝΕΝΑ .asd (μηδέν αναφορές asd στις γραμμές 333-453) ΚΑΙ το βήμα δεν κάνει --entrypoint override — σε αντίθεση με τη γραμμή 306 που το κάνει ρητά για τον ίδιο σκοπό."
   :severity :p1
   :evidence ".github/workflows/docker-orchestrator.yml:L338-L346@sha256:f1a4bb69e6e4 Dockerfile:394-410 .github/workflows/docker-orchestrator.yml:L306-L306@sha256:f1a4bb69e6e4"
   :is-it-in-the-known-defect-list :no)
  (:what "package.json δηλώνει playwright ^1.61.0 (headless Chromium) σε repo που δηλώνει «100% Common Lisp». Η αλυσίδα είναι ΖΩΝΤΑΝΗ και ρυθμισμένη: configs/constitution.yaml:L90-L90@sha256:c2daf8934d68 fetch_cmd «bash deployment/fetch-fek-by-number.sh Α 111 1975 {{out}}» → run-fetch-command /bin/sh -c → deployment/fetch-fek.sh:L16-L16@sha256:42acffc89892 deployment/fetch-fek.sh:L67-L67@sha256:42acffc89892 → node + Playwright. (Το .dockerignore:77 αποκλείει το package.json από την εικόνα, όχι το configs/.)"
   :severity :p1
   :evidence "package.json:L1-L5@sha256:8c4d176620ed configs/constitution.yaml:L90-L90@sha256:c2daf8934d68 source/document-fetch.lisp:L92-L106@sha256:bb114b83fd80 deployment/fetch-fek.sh:L16-L23@sha256:42acffc89892 .dockerignore:77"
   :is-it-in-the-known-defect-list :no)
  (:what "source.fetch_cmd → sh -c είναι RCE-by-design για όποιον μπορεί να επεξεργαστεί ένα corpus YAML· το {{out}} templating είναι αχειραγώγητο/μη-quoted. Το configs/ αντιγράφεται ΜΕΣΑ στο runtime image."
   :severity :p1
   :evidence "docs/SECURITY-REDTEAM.md:L84-L88@sha256:489f6a4c7a31 configs/constitution.yaml:L90-L90@sha256:c2daf8934d68 Dockerfile:400"
   :is-it-in-the-known-defect-list :yes)
  ...
  (:what "5 .asd δηλώνουν test-op (orchestrator, orchestrator-core-runtime, orchestrator-omega, orchestrator-tests, orchestrator-tests-runtime) αλλά ΚΑΝΕΝΑ Dockerfile / .github/workflows / docker-compose δεν καλεί ποτέ asdf test-op — νεκρές δηλώσεις. Η πραγματική εκτέλεση γίνεται μέσω docker/run-standalone-suites.sh."
   :severity :p2
   :evidence "orchestrator-core-runtime.asd:L31-L31@sha256:dba3a133277b orchestrator.asd:L41-L41@sha256:21f72d016312 orchestrator-tests-runtime.asd:L24-L24@sha256:4d44073cbf6f orchestrator-omega.asd:L139-L139@sha256:6c6f2d597908 Dockerfile:189-192"
   :is-it-in-the-known-defect-list :no)
  ...
  (:what "MANUAL-STEPS-HERMETIC.md:L29-L29@sha256:cfd4fd227483 δηλώνει «deps.lock με 48 total dependencies» ενώ το πραγματικό deps.lock έχει 58. Το ίδιο έγγραφο (γραμμή 5) παραδέχεται «~95% hermetic» — που αντιφάσκει με το απόλυτο «hermetic» του Dockerfile:5 και του PROVENANCE.yaml:L293-L293@sha256:bce8df3c6d34. Επίσης διπλή εγγραφή trivial-macroexpand-all (21, 22)."
   ...
   :is-it-in-the-known-defect-list :no)
  (:what "Απόκλιση έκδοσης: SYSTEM-HIERARCHY.txt:L2-L2@sha256:d5665164bce2 «ORCHESTRATOR v1.3»· README.md:L6-L6@sha256:97c747e9aa82 README.md:L389-L389@sha256:97c747e9aa82 + Dockerfile:338 + orchestrator.asd:L13-L13@sha256:21f72d016312 + CHANGELOG.md:L3-L3@sha256:3d1f519e64dd «1.2.0»· CI παράγει tags «v1.3.<run_number>»."
   :severity :p2
   :evidence "SYSTEM-HIERARCHY.txt:L2-L2@sha256:d5665164bce2 README.md:L389-L389@sha256:97c747e9aa82 Dockerfile:338 .github/workflows/docker-orchestrator.yml:L371-L371@sha256:f1a4bb69e6e4"
   :is-it-in-the-known-defect-list :no)
  (:what "SYSTEM-HIERARCHY.txt:L5-L8@sha256:d5665164bce2 δηλώνει «ΚΟΡΥΦΑΙΟ ΣΗΜΕΙΟ ΕΙΣΟΔΟΥ (ONE ENTRY POINT): unified-frbr-generator.lisp» — τρίτη, ασύμβατη δήλωση «μοναδικής εισόδου» δίπλα στο entrypoint.lisp και το orchestrator.cli:main."
   :severity :p2
   :evidence "SYSTEM-HIERARCHY.txt:L5-L8@sha256:d5665164bce2 Dockerfile:452 build.lisp:L44-L44@sha256:baa3527f5cf6"
   :is-it-in-the-known-defect-list :no)
  ...
  (:what ".env.example δηλώνει POSTGRES_/GRAFANA_/SLACK_WEBHOOK/TELEMETRY_ENDPOINT ενώ το docker-compose.yml δεν έχει καμία τέτοια υπηρεσία (postgres/redis είναι σχολιασμένα στις 409-411)."
   :severity :p2
   :evidence ".env.example:22-29 docker-compose.yml:L409-L411@sha256:ff93c313b8fe"
   :is-it-in-the-known-defect-list :no)
 ...
 ((:path "/bin/sh -c <command> (run-fetch-command) → bash deployment/fetch-fek*.sh → node deployment/fetch-fek.js → headless Chromium (Playwright)"
   ...
   :evidence "source/document-fetch.lisp:L92-L106@sha256:bb114b83fd80 configs/constitution.yaml:L90-L90@sha256:c2daf8934d68 deployment/fetch-fek.sh:L16-L23@sha256:42acffc89892 Dockerfile:400")
  (:path "pdftoppm -r 300 -png → tesseract -l ell → which/--list-langs"
   ...
   :evidence "source/pdf-authority.lisp:L1399-L1425@sha256:c4e2054c0e4f Dockerfile:371-373")
  ...
  (:path "docker/entrypoint.lisp run-subprocess (sb-ext:run-program :wait t)"
   ...
   :evidence "docker/entrypoint.lisp:L67-L77@sha256:b4f283f2abed Dockerfile:452")
 ...
 ((:concept "container entrypoint"
   :seats ("entrypoint.lisp:L1-L83@sha256:779402eaf674 — ΟΡΦΑΝΟ: φορτώνει :orchestrator + :orchestrator-tests και ΤΡΕΧΕΙ ΤΗ ΣΟΥΙΤΑ ΤΕΣΤ· αντιγράφεται στον builder (Dockerfile:104) αλλά ΔΕΝ εκτελείται ποτέ"
           "docker/entrypoint.lisp:L1-L182@sha256:b4f283f2abed — ΤΟ ΠΡΑΓΜΑΤΙΚΟ (Dockerfile:409 → /app/entrypoint.lisp, Dockerfile:452)"))
