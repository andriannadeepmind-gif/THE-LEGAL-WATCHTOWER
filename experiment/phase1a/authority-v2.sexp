(:lawmax-phase1a-cluster/1
 ...
 ((:name "OS-enforced write-capability closure (authority/producer/reader uid separation)"
   ...
   :evidence "authority-v2/capability/identities.sh:L28-88 ·
              authority-v2/proofs/verify-capability-closure.sh:L14-86 ·
              authority-v2/store/STORAGE-API.sexp:L48-50")
  ...
  (:name "Merkle έδρα με ΔΥΟ δομικά διαφορετικούς αλγορίθμους MTH + golden vectors n=0..64"
   ...
   :evidence "authority-v2/capture/capture.py:L181-246 (_leaf/_node/_mth_recursive/_mth_streaming/_mth) ·
              L248-292 (verify_merkle_seat) · L84-92 (RETRACTED_CLAIMS) ·
              authority-v2/capture/CAPTURE-PROTOCOL.sexp:L114-152")
  ...
  (:name "Μάρτυρας μεταλλάξεων της capture (μετα-απόδειξη: «περνάει» ≠ «ελέγχει»)"
   ...
   :materiality "ΕΠΑΛΗΘΕΥΤΗΚΕ ΑΡΙΘΜΗΤΙΚΑ: 21 MUTANTS − 3 NON_OBSERVABLE = 18 φονεύσιμες,
                 ...
                 (L119) ΕΙΝΑΙ ΑΚΡΙΒΗΣ."
   :evidence "authority-v2/proofs/capture-mutation-witness.py:L50-162 · L174-186 · L190-197 ·
              L200-213 (build_tree) · L225-231 · L233-267 ·
              authority-v2/LEVEL7-COMPLETION-MATRIX.sexp:L119")
  ...
  (:name "Διαφορικός έλεγχος έδρας: capture.py έναντι του παραγωγικού Lisp πυρήνα"
   ...
   :evidence "authority-v2/proofs/capture-seat-differential-test.sh:L24-115 ·
              authority-v2/tests/probe-canonical-files.lisp:L15-22 ·
              authority-v2/tests/probe-merkle-root-of-files.lisp:L28-34")
  ...
  (:name "Απογραφή αποδείξεων με αναδρομική σάρωση και ΕΝΑΝ κατάλογο εισόδων"
   ...
   :evidence "authority-v2/run-proofs.sh:L37-195 · authority-v2/PROOF-CENSUS.txt:L20-84 ·
              authority-v2/proofs/proof-census-adversarial-test.py:L95-189")
  ...
  (:name "Μηχανικές πύλες συνέπειας του matrix και του proof-manifest"
   ...
   :evidence "authority-v2/proofs/verify-completion-matrix.py:L21-104 ·
              authority-v2/proofs/verify-proof-manifest.py:L17-78 ·
              authority-v2/proofs/gate-negative-fixtures.py:L71-124")
  ...
  (:name "Καθαρός admission kernel K(old,candidate,evidence,policy) + 9 conjuncts + 9 θεωρήματα"
   ...
   :evidence "authority-v2/kernel/admission-model.sexp:L18-33 · L38-70 · L74-111 · L113-118 ·
              authority-v2/LEVEL7-COMPLETION-MATRIX.sexp:L127 ·
              authority-v2/proofs/docker-e2e-test.sh:L86-91")
  ...
  (:name "Κλειστό CDDL σχήμα transition-certificate (15 δεσμευμένα πεδία)"
   ...
   :evidence "authority-v2/schema/transition-certificate.cddl:L28-39 (ρίζα) · L41-45 · L47-51 ·
  ...
  (:name "Authority state / rejection certificate σχήμα (unique-latest ΤΥΠΙΚΑ)"
   ...
   :evidence "authority-v2/schema/state.cddl:L18-27 · L29-35 · L37-48 · L50-63 · L65-69 · L71-85")
  ...
  (:name "Authority store transactional API (6-item atomic commit)"
   ...
   :evidence "authority-v2/store/STORAGE-API.sexp:L17-27 · L31-50 · L52-57 · L59-73")
  ...
  (:name "Witness quorum/freshness policy (format-agnostic)"
   ...
   :evidence "authority-v2/log/witness-policy.sexp:L19-28 · L30-41 · L43-59 · L61-69 · L71-78")
  ...
  (:name "Ceremony tooling (genesis/rotation/revocation/recovery) με πραγματικά ed25519 test keys"
   ...
   :evidence "authority-v2/roles/ceremony.sh:L30-44 (stop point) · L64-81 · L83-100 · L102-115 ·
              L117-131 · L133-137 · authority-v2/proofs/ceremony-rehearsal-test.sh:L10-21")
  ...
  (:name "Producer OS boundary: η άρνηση αποδίδεται στο MOUNT, όχι σε δικαιώματα"
   ...
   :materiality "Είναι το ισχυρότερο μεθοδολογικά κομμάτι της συστάδας: κλείνει την ετυμηγορία
                 ...
                 επιπλέον έλεγχο."
   :evidence "authority-v2/proofs/producer-os-boundary-test.sh:L40-51 · L67-75 · L78-126 ·
              L129-167 · authority-v2/tests/probe-producer-real.lisp:L1-33")
  ...
  (:name "Δηλωμένη τοπολογία ρόλων του docker-compose (ΟΧΙ εκτέλεση)"
   ...
   :evidence "authority-v2/proofs/producer-topology-test.py:L31-46 · L84-166 · L169-207 · L209-250")
  ...
  (:name "Genesis: ντετερμινιστικός legacy snapshot + conformance + sequence-0 adoption certificate"
   ...
   :evidence "authority-v2/genesis/genesis-policy.sexp:L19-78 ·
              authority-v2/genesis/legacy-snapshot.py:L36-41,L199-259 ·
              authority-v2/genesis/conformance-check.py:L29-43,L96-155 ·
              authority-v2/genesis/build-adoption-certificate.py:L37-42,L66-138")
  ...
  (:name "Παγωμένα legacy-tlog fixtures με επαληθεύσιμο RFC 6962 root"
   ...
   :evidence "authority-v2/fixtures/legacy-tlog/MANIFEST.json:L1-24 ·
              authority-v2/fixtures/legacy-tlog/REMOVED-tlog-writers.lisp.txt:L1-26 ·
              authority-v2/tests/probe-frozen-mutants.lisp:L11-51 ·
              authority-v2/proofs/delta23-evidence-bundle.sh:L72-87,L98-107")
  ...
  (:name "Υπογεγραμμένο genesis fixture (ed25519, επαληθεύσιμο εσαεί / μη επανυπογράψιμο)"
   ...
   :evidence "authority-v2/fixtures/genesis-cert-fixture.json · .sig (64 bytes) ·
              ...
              authority-v2/fixtures/test-keys/README.md:L1-30")
  ...
  (:name "Hermetic toolchain builds ως δηλωμένο μονοπάτι άρσης των :externally-blocked"
   ...
   :evidence "authority-v2/toolchain/everparse.Dockerfile:L21-72 ·
              authority-v2/toolchain/perennial.Dockerfile:L17-57 ·
              authority-v2/toolchain/trusted-toolchain-manifest.sexp:L25-69 ·
              authority-v2/proof-manifest.sexp:L20-26")
  ...
  (:name "End-to-end refinement obligation (spec→source→binary→rebuild→runtime)"
   ...
   :evidence "authority-v2/toolchain/trusted-toolchain-manifest.sexp:L18-105"))
 ...
 ((:name "lawmax-authority (uid 11001)"
   ...
   :enforcement :os
   :evidence "authority-v2/capability/identities.sh:L46,L76-77 ·
              authority-v2/proofs/verify-capability-closure.sh:L47-53")
  (:name "lawmax-producer (uid 11002)"
   ...
   :evidence "authority-v2/capability/identities.sh:L47,L80-81 ·
              authority-v2/proofs/verify-capability-closure.sh:L56-61,L70-75 ·
              authority-v2/toolchain/trusted-toolchain-manifest.sexp:L95-97")
  (:name "lawmax-reader (uid 11003, ομάδα lawmax-readers 11010)"
   ...
   :evidence "authority-v2/capability/identities.sh:L48-49,L70 ·
              authority-v2/proofs/verify-capability-closure.sh:L62-67,L77-82")
  (:name "read-only bind mount πάνω στο legacy releases/"
   ...
   :enforcement :os
   :evidence "authority-v2/proofs/producer-os-boundary-test.sh:L78-126 (EROFS=30, όχι EACCES=13)")
  (:name "openat2 RESOLVE_BENEATH|NO_SYMLINKS|NO_XDEV κάτω από την άγκυρα"
   ...
   :enforcement :os
   :evidence "authority-v2/capture/capture.py:L94-99,L143-160,L168-170 · L895-912")
  (:name "_CapabilityToken / _Sealed (Anchor, CanonicalProfile)"
   ...
   :evidence "authority-v2/capture/capture.py:L317-360 · L595-623")
  (:name "PINNED_CANONICAL_PROFILE_SHA256"
   ...
   :enforcement :code
   :evidence "authority-v2/capture/capture.py:L77-81,L648-656 (ΕΠΑΛΗΘΕΥΤΗΚΕ: ταιριάζει)")
  (:name "owner root role (offline)"
   ...
   :evidence "authority-v2/roles/ROLES-MODEL.sexp:L28-37,L90-95 · authority-v2/roles/ceremony.sh:L30-44")
  (:name "release role"
   ...
   :evidence "authority-v2/roles/ROLES-MODEL.sexp:L39-44 ·
              authority-v2/schema/transition-certificate.cddl:L125-129")
  (:name "PROOF-CENSUS.txt (ο κλειστός κατάλογος εισόδων)"
   ...
   :enforcement :code
   :evidence "authority-v2/run-proofs.sh:L75-126 · authority-v2/PROOF-CENSUS.txt:L20-84")
  (:name "LEVEL7-COMPLETION-MATRIX.sexp + proof-manifest.sexp (οι πύλες τιμιότητας)"
   ...
   :evidence "authority-v2/LEVEL7-COMPLETION-MATRIX.sexp:L23-25,L252-259 ·
              authority-v2/proof-manifest.sexp:L16-18,L60-64")
  (:name "LAWMAX_CEREMONY_MODE=production (το stop point)"
   ...
   :enforcement :code
   :evidence "authority-v2/roles/ceremony.sh:L30-44,L133-137")
  (:name "AUTHORITY_V2_REQUIRE_ALL=1"
   ...
   :enforcement :code
   :evidence "authority-v2/run-proofs.sh:L26,L163-180 ·
              authority-v2/LEVEL7-COMPLETION-MATRIX.sexp:L130"))
 ...
 ((:statement "unique-latest: το σχήμα ΔΕΝ ΕΠΙΤΡΕΠΕΙ δεύτερο latest (τυπικά, όχι με έλεγχο)"
  ...
  (:statement "rejection ⇒ καμία μεταβολή κατάστασης (state-hash ΠΡΙΝ == ΜΕΤΑ, ελέγξιμο από τρίτο)"
   ...
   :evidence "authority-v2/schema/state.cddl:L71-85")
  (:statement "TSA ΜΟΝΟ pinned — ΠΟΤΕ unpinned"
   :enforced-by "κλειστό literal «pinned» ως τιμή του key 9 στο tsa-evidence"
   :evidence "authority-v2/schema/transition-certificate.cddl:L82 ·
              authority-v2/kernel/admission-model.sexp:L58-63")
  (:statement "new.sequence = old.sequence + 1 ΑΚΡΙΒΩΣ, χωρίς κενά"
   ...
   :evidence "authority-v2/kernel/admission-model.sexp:L43-44 ·
              authority-v2/schema/transition-certificate.cddl:L44")
  (:statement "Η K ΔΕΝ τρέχει ΠΟΤΕ πάνω στο candidates/ — μόνο πάνω σε συλληφθέν snapshot"
   ...
   :evidence "authority-v2/capture/CAPTURE-PROTOCOL.sexp:L27-61 ·
              authority-v2/capture/capture.py:L895-912")
  (:statement "τοπικοί fake witnesses ΔΕΝ μετρούν ΠΟΤΕ στο κβόρουμ"
   ...
   :evidence "authority-v2/log/witness-policy.sexp:L71-78 ·
              authority-v2/proofs/witness-quorum-test.py:L71-77")
  (:statement "BLOCKED ΔΕΝ ΕΙΝΑΙ ΠΟΤΕ PASS — τοπικά exit 3 (ΑΤΕΛΕΣ), σε CI ΣΦΑΛΜΑ"
   ...
   :evidence "authority-v2/run-proofs.sh:L163-194 · authority-v2/run-all.sh:L29-33,L70-72 ·
              authority-v2/proofs/docker-e2e-test.sh:L25-27")
  (:statement "ΚΑΘΕ .py/.sh/.lisp κάτω από authority-v2/ ταξινομείται ΑΚΡΙΒΩΣ ΜΙΑ ΦΟΡΑ"
   ...
   :evidence "authority-v2/run-proofs.sh:L62-73,L98-125")
  (:statement "καμία απόδειξη δεν ζει έξω από το proofs/ και κανένα εργαλείο μέσα του"
   ...
   :evidence "authority-v2/run-proofs.sh:L106-125")
  (:statement "κανένα symlink κάτω από το authority-v2/"
   :enforced-by "find -type l ⇒ exit 1"
   :evidence "authority-v2/run-proofs.sh:L53-57")
  (:statement "καμία CL/Python υλοποίηση CBOR δεν μπαίνει στο TCB ούτε παγιώνει wire format"
   ...
   :evidence "authority-v2/LEVEL7-COMPLETION-MATRIX.sexp:L85-87 ·
              authority-v2/toolchain/everparse.Dockerfile:L11-12")
  (:statement "καμία υλοποίηση πίσω από το STORAGE-API (absent-by-design)"
   ...
   :evidence "authority-v2/store/STORAGE-API.sexp:L20-27 ·
              authority-v2/LEVEL7-COMPLETION-MATRIX.sexp:L155")
  (:statement "τα legacy δεδομένα ΔΕΝ διαγράφονται/μετακινούνται/ξαναγράφονται"
   ...
   :evidence "authority-v2/genesis/genesis-policy.sexp:L30-36 ·
              authority-v2/proofs/producer-os-boundary-test.sh:L125-126,L165-167")
  (:statement "κανένα legacy release δεν κληρονομεί authority (evidence-only)"
   ...
   :evidence "authority-v2/genesis/genesis-policy.sexp:L24-28 ·
              authority-v2/genesis/out/legacy-conformance.json:L1"))
 ...
 ((:what "ΤΟ ΚΕΝΤΡΙΚΟ ΕΥΡΗΜΑ — 8 ΑΠΟ ΤΑ 13 ΔΗΛΩΤΙΚΑ ΑΡΤΕΦΑΚΤΑ ΕΧΟΥΝ ΜΗΔΕΝ ΑΝΑΓΝΩΣΤΕΣ ΚΩΔΙΚΑ.
   ...
   :severity :p0
   :evidence "authority-v2/kernel/admission-model.sexp:L1-118 ·
              authority-v2/store/STORAGE-API.sexp:L1-73 ·
              authority-v2/log/witness-policy.sexp:L1-78 ·
              authority-v2/roles/ROLES-MODEL.sexp:L1-95 ·
              authority-v2/capture/CAPTURE-PROTOCOL.sexp:L1-174 ·
              authority-v2/schema/transition-certificate.cddl:L1-129 ·
              authority-v2/schema/state.cddl:L1-85 ·
              authority-v2/toolchain/trusted-toolchain-manifest.sexp:L1-105 ·
              authority-v2/PROOF-CENSUS.txt:L50-84 (ο κατάλογος όσων τρέχουν)"
  ...
  (:what "ΣΠΑΣΜΕΝΗ ΑΥΤΟ-ΔΕΣΜΕΥΣΗ ΤΟΥ SEQUENCE-0 CERTIFICATE ΣΤΟ ΠΑΓΩΜΕΝΟ ΔΕΝΤΡΟ. Το committed
   ...
   :severity :p0
   :evidence "authority-v2/genesis/out/legacy-adoption-certificate.unsigned.json:L1 ·
              authority-v2/genesis/out/legacy-snapshot.json:L1 ·
              authority-v2/genesis/build-adoption-certificate.py:L73 ·
  ...
  (:what "ΟΙ ΔΥΟ «ΠΥΛΕΣ ΤΙΜΙΟΤΗΤΑΣ» ΕΠΑΛΗΘΕΥΟΥΝ ΚΕΙΜΕΝΟ, ΟΧΙ ΕΚΤΕΛΕΣΗ. Το :actual-result είναι
   ...
   :severity :p1
   :evidence "authority-v2/proofs/verify-completion-matrix.py:L11-12 (ο ισχυρισμός) · L68-76 ·
              authority-v2/proofs/verify-proof-manifest.py:L54-59 ·
              authority-v2/proofs/gate-negative-fixtures.py:L77-121 (όλες οι μεταλλάξεις)"
   :is-it-in-the-known-defect-list :no)
  ...
  (:what "Ο ΙΣΧΥΡΙΣΜΟΣ «Καμία εξάρτηση από όνομα ή bit εκτέλεσης» ΕΙΝΑΙ ΨΕΥΔΗΣ ΣΤΟΝ ΙΔΙΟ ΤΟΝ
   ...
   :severity :p1
   :evidence "authority-v2/run-proofs.sh:L40-41,L43-48 (ο ισχυρισμός) · L71 (η υλοποίηση) ·
              authority-v2/PROOF-CENSUS.txt:L34-36 (ο ίδιος ισχυρισμός) ·
              authority-v2/proofs/proof-census-adversarial-test.py:L130-164 (τα strays)"
   :is-it-in-the-known-defect-list :no)
  ...
  (:what "ΑΣΥΜΜΕΤΡΙΑ PINNING ΜΕΣΑ ΣΤΟΝ ΙΔΙΟ ΕΛΕΓΧΟ. Το canonical profile ελέγχεται απέναντι σε
   ...
   :severity :p1
   :evidence "authority-v2/capture/capture.py:L72-75 (GOLDEN_VECTORS) · L248,L255-261 ·
              L77-81,L648-656 (το profile ΕΙΝΑΙ pinned) ·
              authority-v2/proofs/capture-adversarial-test.py:L357-364 (η επίθεση ΜΟΝΟ για profile)"
   :is-it-in-the-known-defect-list :no)
  ...
  (:what "ΤΕΣΤ-ΤΑΥΤΟΛΟΓΙΑ ΜΕ ΔΙΠΛΗ ΕΔΡΑ ΣΤΟΥΣ ΜΑΡΤΥΡΕΣ. Το witness-quorum-test.py, που το matrix
   ...
   :severity :p1
   :evidence "authority-v2/proofs/witness-quorum-test.py:L17-19 · L52-78 · L1-117 (μηδέν αναφορές) ·
              authority-v2/log/witness-policy.sexp:L48-49,L63-64 ·
  ...
  (:what "ΤΟ ΙΔΙΟ ΣΧΗΜΑ ΣΤΟΥΣ ΡΟΛΟΥΣ: το ceremony.sh καρφώνει τα 5 ονόματα ρόλων και τα 4
   ...
   :severity :p1
   :evidence "authority-v2/roles/ceremony.sh:L67,L70,L124 ·
              authority-v2/roles/ROLES-MODEL.sexp:L28-65 ·
              authority-v2/LEVEL7-COMPLETION-MATRIX.sexp:L181-185"
   :is-it-in-the-known-defect-list :no)
  ...
  (:what "ΤΟ ΜΟΝΑΔΙΚΟ ΥΠΟΓΕΓΡΑΜΜΕΝΟ ARTIFACT ΕΧΕΙ ΑΠΟΚΛΙΝΕΙ ΑΠΟ ΤΟ ΠΑΡΑΓΟΜΕΝΟ. Το
   ...
   :evidence "authority-v2/fixtures/genesis-cert-fixture.json:L1 ·
              ...
              authority-v2/fixtures/test-keys/genesis-test-ed25519.pub:L1-3 ·
              authority-v2/fixtures/test-keys/README.md:L10-17 ·
  ...
  (:what "ΟΛΟΚΛΗΡΟ ΤΟ genesis/ ΕΙΝΑΙ ΕΚΤΟΣ ΚΑΘΕ ΠΥΛΗΣ. Τα 3 python αρχεία είναι ταξινομημένα
   ...
   :severity :p1
   :evidence "authority-v2/PROOF-CENSUS.txt:L69-72 ·
              authority-v2/run-proofs.sh:L119-125,L159-161 ·
              authority-v2/genesis/build-adoption-certificate.py:L45-138"
   :is-it-in-the-known-defect-list :no)
  ...
  (:what "ΤΟ ΔΗΛΩΜΕΝΟ ΜΟΝΟΠΑΤΙ ΑΡΣΗΣ ΤΩΝ 7 :externally-blocked ΑΠΑΙΤΗΣΕΩΝ ΕΙΝΑΙ ΑΤΕΛΕΣ. Και τα
   ...
   :severity :p1
   :evidence "authority-v2/toolchain/everparse.Dockerfile:L50-54,L64-72 ·
              authority-v2/toolchain/perennial.Dockerfile:L43-47,L49-57 ·
              authority-v2/proof-manifest.sexp:L20-26 ·
  ...
  (:what "ΤΟ delta23-evidence-bundle.sh ΔΗΛΩΝΕΙ ΤΗΝ ΥΠΟΧΡΕΩΣΗ ② ΩΣ «Η ΦΕΡΟΥΣΑ ΑΠΟΔΕΙΞΗ» ΚΑΙ ΤΗΝ
   ...
   :severity :p1
   :evidence "authority-v2/proofs/delta23-evidence-bundle.sh:L3-4,L48-61,L118-119 ·
              authority-v2/PROOF-CENSUS.txt:L64"
   :is-it-in-the-known-defect-list :no)
  ...
  (:what "verify-capability-closure.sh ΣΥΜΠΕΡΑΙΝΕΙ ΑΡΝΗΣΗ ΑΠΟ ΟΠΟΙΟΔΗΠΟΤΕ ΜΗ ΜΗΔΕΝΙΚΟ EXIT, όχι
   ...
   :severity :p1
   :evidence "authority-v2/proofs/verify-capability-closure.sh:L40-45 · L47-53 · L55-67 ·
              authority-v2/proofs/producer-os-boundary-test.sh:L108-116 (η ανώτερη μέθοδος, δίπλα)"
   :is-it-in-the-known-defect-list :no)
  ...
  (:what "ΤΟ ΛΕΞΙΛΟΓΙΟ ΑΠΟΡΡΙΨΕΩΝ ΤΟΥ ΠΡΩΤΟΚΟΛΛΟΥ ΔΕΝ ΣΥΜΦΩΝΕΙ ΜΕ ΤΟΝ ΚΩΔΙΚΑ ΚΑΙ ΚΑΝΕΝΑ GATE
   ...
   :severity :p2
   :evidence "authority-v2/capture/CAPTURE-PROTOCOL.sexp:L63-89 (L65 :symlink-present,
              L72 :declared-root-mismatch) · authority-v2/capture/capture.py:L155-156 (ELOOP ⇒
  ...
  (:what "ΤΟ canonical-profile.json ΔΕΙΧΝΕΙ ΣΕ ΑΝΥΠΑΡΚΤΟ ΜΟΝΟΠΑΤΙ ΚΑΙ ΤΟ PINNING ΤΟ ΠΑΓΩΝΕΙ:
   ...
   :evidence "authority-v2/capture/canonical-profile.json:L3 ·
              ...
              authority-v2/capture/capture.py:L77-81"
   :is-it-in-the-known-defect-list :no)
  ...
  (:what "Η capture() ΑΝΤΙΚΑΘΙΣΤΑ ΤΗΝ ΑΙΤΙΑ ΤΗΣ ΑΡΝΗΣΗΣ ΟΤΑΝ ΑΠΟΤΥΓΧΑΝΕΙ Ο ΚΑΘΑΡΙΣΜΟΣ. Το
   ...
   :severity :p2
   :evidence "authority-v2/capture/capture.py:L981-991"
   :is-it-in-the-known-defect-list :no)
  ...
  (:what "ΝΕΚΡΟΙ HELPERS ΠΟΥ Η ΑΠΟΓΡΑΦΗ ΝΟΜΙΜΟΠΟΙΕΙ ΜΟΝΙΜΑ. Η απογραφή ελέγχει ΝΕΚΡΕΣ ΕΓΓΡΑΦΕΣ
   ...
   :severity :p2
   :evidence "authority-v2/tests/probe-attest-refusal.lisp:L1-35 ·
              authority-v2/tests/probe-producer-under-uid.lisp:L1-50 ·
              authority-v2/tests/probe-producer-real.lisp:L1-33 (ο ενεργός) ·
              authority-v2/PROOF-CENSUS.txt:L31-36,L75,L83 · authority-v2/run-proofs.sh:L105"
   :is-it-in-the-known-defect-list :no)
  ...
  (:what "ΤΟ MATRIX ΔΙΝΕΙ ΔΥΟ ΔΙΑΦΟΡΕΤΙΚΟΥΣ ΑΡΙΘΜΟΥΣ ΓΙΑ ΤΑ ΙΔΙΑ TESTS ΧΩΡΙΣ ΣΥΜΦΙΛΙΩΣΗ:
   ...
   :severity :p2
   :evidence "authority-v2/LEVEL7-COMPLETION-MATRIX.sexp:L115-122 · L246 ·
              authority-v2/PROOF-CENSUS.txt:L51-66 (15 αποδείξεις)"
   :is-it-in-the-known-defect-list :no)
  ...
  (:what "Το ceremony.sh, αν κληθεί ΧΩΡΙΣ LAWMAX_CEREMONY_WORK, γράφει ed25519 ΙΔΙΩΤΙΚΑ ΚΛΕΙΔΙΑ
   ...
   :severity :p2
   :evidence "authority-v2/roles/ceremony.sh:L25,L46-51 ·
              authority-v2/proofs/ceremony-rehearsal-test.sh:L5 ·
              authority-v2/PROOF-CENSUS.txt:L42-44"
   :is-it-in-the-known-defect-list :no)
  ...
  (:what "verify-capability-closure.sh: στις ΘΕΤΙΚΕΣ περιπτώσεις καθαρίζει τα probe αρχεία ΩΣ Ο
   ...
   :severity :p2
   :evidence "authority-v2/proofs/verify-capability-closure.sh:L48-53,L56-58,L62-64,L70-75"
   :is-it-in-the-known-defect-list :no)
  ...
  (:what "Ο έλεγχος παλινδρόμησης ⑥ του capture-mountpoint-test.sh είναι ΠΕΡΙΒΑΛΛΟΝΤΙΚΑ
   ...
   :severity :p2
   :evidence "authority-v2/proofs/capture-mountpoint-test.sh:L113-142"
   :is-it-in-the-known-defect-list :no)
  ...
  (:what "Οι γραμμές 5 και 12 του matrix δηλώνουν implementation ΕΚΤΟΣ της συστάδας
   ...
   :evidence "authority-v2/LEVEL7-COMPLETION-MATRIX.sexp:L110-112,L239-243 ·
              authority-v2/proofs/verify-completion-matrix.py:L22-24 (το :implementation
  ...
  (:what "probe-producer-real.lisp και probe-producer-under-uid.lisp αποδίδουν ΚΑΘΕ error στον
   ...
   :severity :p2
   :evidence "authority-v2/tests/probe-producer-real.lisp:L26-31 ·
              authority-v2/tests/probe-producer-under-uid.lisp:L40-47 ·
              authority-v2/proofs/producer-os-boundary-test.sh:L144-152"
   :is-it-in-the-known-defect-list :no))
 ...
 ((:path "authority-v2/proofs/producer-os-boundary-test.sh ΕΚΤΕΛΕΙ ΤΟΝ ΕΓΚΑΤΑΣΤΑΤΗ identities.sh"
   ...
   :evidence "authority-v2/proofs/producer-os-boundary-test.sh:L34-35 ·
              authority-v2/capability/identities.sh:L73-81")
  (:path "authority-v2/proofs/delta23-evidence-bundle.sh ΕΚΤΕΛΕΙ ΔΥΟ ΑΛΛΕΣ ΑΠΟΔΕΙΞΕΙΣ ΜΕΣΑ ΤΟΥ"
   ...
   :evidence "authority-v2/proofs/delta23-evidence-bundle.sh:L52-61,L110-115 ·
              authority-v2/PROOF-CENSUS.txt:L52,L56,L64")
  ...
  (:path "authority-v2/tests/build-authority-core.lisp ΦΟΡΤΩΝΕΙ ΟΛΟ ΤΟΝ ΠΑΡΑΓΩΓΙΚΟ ΠΥΡΗΝΑ"
   ...
   :evidence "authority-v2/tests/build-authority-core.lisp:L4-14 · authority-v2/run-all.sh:L44-54")
  (:path "capture-mutation-witness.py ΤΡΕΧΕΙ 22 ΦΟΡΕΣ ΤΟ ΠΛΗΡΕΣ ADVERSARIAL HARNESS"
   ...
   :evidence "authority-v2/proofs/capture-mutation-witness.py:L216-219,L248-252,L263-264")
  (:path "verify_merkle_seat(vectors_path=…) ΔΕΧΕΤΑΙ ΑΥΘΑΙΡΕΤΟ PATHNAME"
   ...
   :evidence "authority-v2/capture/capture.py:L248 · L614-623 (ο φρουρός που ΥΠΑΡΧΕΙ για το profile)"))
 ...
 ((:concept "ΠΟΛΙΤΙΚΗ ΚΒΟΡΟΥΜ/ΦΡΕΣΚΑΔΑΣ ΜΑΡΤΥΡΩΝ — δύο ανεξάρτητοι ορισμοί, κανένας σύνδεσμος"
  ...
  (:concept "MTH / Merkle αλγόριθμος — ΠΕΝΤΕ υλοποιήσεις (οι τρεις είναι ΣΚΟΠΙΜΕΣ ως διαφορικές)"
   :seats ("authority-v2/capture/capture.py:L196-205 (_mth_recursive)"
           ...
           "authority-v2/genesis/legacy-snapshot.py:L57-71 (mth — ΤΕΤΑΡΤΗ, χωρίς διαφορικό έλεγχο)"
  ...
  (:concept "PROBE ΤΟΥ PRODUCER ΥΠΟ UID — δύο σχεδόν ταυτόσημα αρχεία, το ένα νεκρό"
   :seats ("authority-v2/tests/probe-producer-real.lisp:L1-33 (ενεργό)"
           "authority-v2/tests/probe-producer-under-uid.lisp:L1-50 (κανένας καλών)"))
  (:concept "ΔΗΛΩΣΗ ΓΝΩΣΤΩΝ ΑΠΟΚΛΙΣΕΩΝ — τρεις έδρες με ΔΙΑΦΟΡΕΤΙΚΟ περιεχόμενο"
   :seats ("authority-v2/genesis/genesis-policy.sexp:L65-78 (3 divergences)"
           "authority-v2/genesis/build-adoption-certificate.py:L88-113 (5 divergences)"
 ...
 ("Αν το ΠΕΡΙΕΧΟΜΕΝΟ των αρχείων εκτός συστάδας που δηλώνει το matrix (systems/orchestrator-epistemic/
  ...
  "Αν το repo guard `*.key` υπάρχει όντως (αναφέρεται στο authority-v2/fixtures/test-keys/README.md:L10-11)
   — δεν το αναζήτησα εκτός της συστάδας"
  "Αν το LAWMAX_AUTHORITY_UID/PRODUCER_UID/READER_UID αναφέρονται όντως «αυτούσια στο
   docker-compose.yml» όπως ισχυρίζεται το authority-v2/capability/identities.sh:L44-45 — το compose είναι εκτός συστάδας"))
