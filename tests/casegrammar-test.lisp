...
(check "«συναίνεση του κατόχου» ⇒ value = ΤΟ ΘΕΜΑ (:theme slot, όχι σταθερά)"
       (let* ((fs (facts "Ο δράστης αφαίρεσε τα ξένα κινητά εργαλεία, αλλά είχε τη συναίνεση του κατόχου."))
              (theme (pred-obj fs :αφαιρεί)))
         (and theme
              (find-if (lambda (x) (and (eq (third x) :έχει-συναίνεση-κατόχου)
