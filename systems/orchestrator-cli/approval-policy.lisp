...
(defvar *policies-path*
  (merge-pathnames "deployment/self/policies.sexp" (uiop:getcwd))
  "Το ημερολόγιο πολιτικών έγκρισης — append-only, versioned (αποφάσεις δημιουργού).")
